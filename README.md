...
- **1337 Morocco Student**
  ...
  ### Common Core :
    ...
    - [Ft_trenscandence](https://github.com/YounesMoukhlij/ft_trenscandence): NextJs, Docker, NodeJs, SQL ... - Fullstack application, It is a real-time multiplayer ping-pong platform with social features, tournaments, and OAuth-based authentication.
